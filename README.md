...
- **The roster is not a notification.** Nothing is pushed or emailed; a firm that does not open the
  page is told nothing. The daily digest remains per company and goes to the client's own people,
  not to their accountant.
